...
class RAGNodes:
    ...
    def generate_answer(self, state: RAGState) -> RAGState:
        ...
        # Create prompt
        prompt = f"""Answer the question based on the Department related context. for all the other questions answer that I only reply department related questions.
